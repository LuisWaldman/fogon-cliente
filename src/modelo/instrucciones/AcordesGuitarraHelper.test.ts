...
describe('Pruebo Los acordes de guitarra', () => {
  describe('GetAcorde - Devuelve acordes de guitarra', () => {
    ...
    it('debe devolver el acorde B correctamente con cejilla', () => {
      const acorde = AcordesGuitarraHelper.getAcorde('B')
