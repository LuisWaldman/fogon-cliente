...
const cancionesPorBanda = {
  "Andrés Calamaro": [
    { nombre: "Comedor Piquetero", archivo: "andres-calamaro_comedor-piquetero" },
    { nombre: "Tuyo Siempre", archivo: "andres-calamaro_tuyo-siempre" }
  ],
  "Damas Gratis": [
    { nombre: "No te creas tan importante", archivo: "damas-gratis_no-te-creas-tan-importante" }
  ],
  "Intoxicados": [
  ...
  "Joaquín Sabina": [
    { nombre: "A la orilla de la chimenea", archivo: "joaquin-sabina_a-la-orilla-de-la-chimenea" }
  ],
  "Viejas Locas": [
    { nombre: "Balada para otra mujer", archivo: "viejas-locas_balada-para-otra-mujer" },
...
<div v-for="(canciones, banda) in cancionesPorBanda" :key="banda">
    <h2>{{ banda }}</h2>
    <ul>
      <li v-for="(cancion, index) in canciones" :key="index">
        <router-link :to="'/tocar?cancion=' + cancion.archivo">{{ cancion.nombre }}</router-link>
      </li>
    </ul>
  </div>
</template>
